  ...
  try {
    ...
    const serialized = pendingOrders.map((o) => ({
      ...
      items: o.items.map((it) => ({
        ...
        promotionDiscount: Number(it.promotionDiscount || 0),
        subtotal: Number(it.subtotal || 0),
        hppUnit: Number(it.hppUnit || 0),
        hppTotal: Number(it.hppTotal || 0),
