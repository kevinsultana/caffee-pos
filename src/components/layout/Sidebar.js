...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      {
        label: 'Arus Kas (In/Out)',
        href: '/dashboard/pos/cash',
        permission: 'MENU_CASH_FLOW',
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        permission: 'MENU_ALL_TRANSACTIONS',
        exact: true,
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  {
    title: 'Master Produk & Pelanggan',
    items: [
      {
        label: 'Daftar Menu Produk',
      ...
      },
      {
        ...
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25l6-6m4.5-3.493V8.25a2.25 2.25 0 01-.659 1.591L9.75 19.932a2.25 2.25 0 01-1.591.659H4.5A2.25 2.25 0 012.25 18.341V14.25c0-.597.237-1.17.659-1.591L12.99 2.568A2.25 2.25 0 0114.58 1.91h3.67c.622 0 1.25.503 1.25 1.125v1.722z" />
          </svg>
        ),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Pembelian (Purchasing)',
        href: '/dashboard/inventory/purchases',
        permission: 'MENU_PURCHASING',
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      ...
      {
        label: 'Unit & Kategori Bahan',
        href: '/dashboard/inventory/setup',
        permission: 'MENU_INVENTORY_SETUP',
        icon: (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
